...
\node[inner sep=0pt] (casing) at (10,1)
    {\includegraphics[width=.14\textwidth]{Simulation_sayem/pictures/casing.jpg}};
    
\node<1>[inner sep=0pt] (PSU) at (9,-2)
    {\includegraphics[width=.12\textwidth]{Simulation_sayem/pictures/powerSupply.jpg}};
\node<2>[inner sep=0pt] (PSU) at (9,-2)
    {\includegraphics[width=.14\textwidth]{Simulation_sayem/pictures/powerSupply.jpg}};
...
\draw<2> [active edge] (PSU) --(casing);
\draw<2> [active edge] (motherboard) --(casing);
